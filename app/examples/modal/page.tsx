    ...
    <main className="container mx-auto">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 auto-rows-max	gap-6 m-10">
        {["1","2","3","4","5","6","7","8","9"].map((id) => (
          <Link key={id} href={`/examples/modal/contents/${id}`} className="aspect-square flex place-content-center place-items-center dark:bg-gray-800 bg-gray-400 text-9xl">
            {id}
          </Link>
        ))}
      </div>
